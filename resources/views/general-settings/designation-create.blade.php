                                        ...
                                        <select class="form-select form-select-sm" id="label_id" name="label_id" required>
                                            ...
                                            @foreach ($labels as $label)
                                                <option value="{{ $label->id }}"
                                                    @if (isset($designation)) {{ $label->id == $designation->label_id ? 'selected' : '' }} @endif>
                                                    {{ $label->label }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text"
                                            ...
                                            class="form-control form-control-sm" id="designation_bn" name="designation_bn"
                                            required>
                                    </div>
                                </div>
                            </div>
