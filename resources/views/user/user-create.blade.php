                                        ...
                                        <div class="col-xl-12">
                                            <div class="site-card">
                                                ...
                                                <div class="site-card-body">
                                                    <form action="https://hyiprio.tdevs.co/admin/user/2835"
                                                        method="post">
                                                        <div class="row">
                                                            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                                                <div class="site-input-groups">
                                                                    <label for="" class="box-input-label">First
                                                                        Name:</label>
                                                                    <input type="text" class="box-input" value="Mahfuz"
                                                                        name="first_name" required="">
                                                                </div>
                                                            </div>
                                                            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                                                <div class="site-input-groups">
                                                                    <label for="" class="box-input-label">Last
                                                                        Name:</label>
                                                                    <input type="text" class="box-input" value="Ahmed"
                                                            ...
                                                            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                                                <div class="site-input-groups">
                                                                    ...
                                                                    <input type="text" class="box-input" value="+880 "
                                                                        disabled="">
                                                                </div>
                                                            </div>
                                                            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-12">
                                            <div class="site-card">
                                                ...
                                                <div class="site-card-body">
                                                    <form
                                                        action="https://hyiprio.tdevs.co/admin/user/password-update/2835"
                                                        method="post">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-12 col-md-5">
                                                                    <div class="dataTables_info"
                                                                        id="user-investment-dataTable_info"
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-12 col-md-6">
                                                                    <div class="dataTables_length"
                                                                        ...
                                                                        <label>Show <select
                                                                                name="user-profit-dataTable_length"
                                                    ...
                                                    <div class="site-datatable">
                                                        <div id="user-transaction-dataTable_wrapper"
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-12 col-md-5">
                                                                    <div class="dataTables_info"
                                                                        id="user-transaction-dataTable_info"
