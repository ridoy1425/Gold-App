                ...
                <div class="m-3">
                    ...
                    <form method="GET" action="{{ url('appraisal/search') }}" id="report_form" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="mb-1 ">
                                    <label for="status" class=" col-form-label col-form-label-sm">Status <span
                                            class="important_field">*</span></label>
                                    <div class="">
                                        <select class="form-select-sm form-select" id="status" name="status">
                                ...
                                @foreach ($employees as $employee)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="button"
                                                href="{{ route('evaluation-edit', ['id' => $employee->id, 'year' => $year ?? '', 'status' => $status ?? '']) }}">
                                                @if ($status === 'approved')
                                                    Edit Form
