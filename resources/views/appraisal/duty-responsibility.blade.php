        ...
        <div class="container">
            ...
            <div class="card card-default">
                <div class=" ml-auto mb-2 mt-2 mr-3">
                    <a class="btn btn-warning" href="{{ url('appraisal/responsibility/create') }}">Add New</a>
                </div>
                <div class="card-body">
                        ...
                        <tbody>
                            @foreach ($entities as $entity)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ URL('appraisal/responsibility/edit', $entity->id) }}"><i
                                                class="fas fa-edit"></i></a>
                                        <a style="color:red;"
                                            href="{{ URL('appraisal/responsibility/delete', $entity->id) }}"><i
