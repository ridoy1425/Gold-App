                                            ...
                                            <div class="modal-body popup-body">
                                                ...
                                                <div class="kyc_container">
                                                    <div class="popup-body-text" id="kyc-action-data">
                                                        ...
                                                        <form action="{{ url('kyc/status-update') }}" method="post">
                                                            @csrf
                                                            ...
                                                            <input type="hidden" value="{{ $label->id }}" name="kyc_id">
                                                            <div class="user_bank_info">
                                                                ...
                                                                <div class="input__group">
                                                                    <div class="site-input-groups ">
                                                                        <label for="" class="box-input-label">Account
                                                                            Name</label>
                                                                        <input type="text"
                                                                ...
                                                                <div class="input__group">
                                                                    <div class="site-input-groups">
                                                                        <label for="" class="box-input-label">Bank
                                                                            Name</label>
                                                                        <input type="text"
                                                                            value="{{ optional($label->user->bankInfo)->bank_name }}">
                                                                    </div>
                                                                    <div class="site-input-groups">
                                                                        <label for="" class="box-input-label">Branch
                                                                            Name</label>
                                                                        <input type="text"
                                                                ...
                                                                <div class="input__group">
                                                                    <div class="site-input-groups">
                                                                        <label for="" class="box-input-label">Routing
                                                                            Number</label>
                                                                        <input type="text"
