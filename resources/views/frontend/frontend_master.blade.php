...
<head>
	...
	<link rel="icon" href="{{ asset('images/ywca.png') }}">
...
<body>
	...
	{{-- <script src="{{ url('ui/frontend_assets') }}/js/vendor/jquery.slim.min.js"></script> --}}
	{{-- <script src="{{ url('ui/frontend_assets') }}/js/vendor/jquery-3.5.1.js"></script> --}}
	...
	<script src="{{ url('ui/frontend_assets/js/vendor/bootstrap.bundle.min.js') }}"></script>
	<script src="{{ url('ui/frontend_assets/js/vendor/smooth-scroll.polyfills.min.js') }}"></script>
