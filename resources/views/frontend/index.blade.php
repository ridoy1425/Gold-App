			...
			<div class="container">
				<nav>
					<div class="nav nav-tabs" id="nav-tab" role="tablist">
						<a class="nav-link active" id="nav-one-tab" data-toggle="tab" href="#nav-one" role="tab" aria-controls="nav-one" aria-selected="true">
							<span class="icon">
						...
						<a class="nav-link" id="nav-two-tab" data-toggle="tab" href="#nav-two" role="tab" aria-controls="nav-two" aria-selected="false">
							<span class="icon">
								<svg width="55" height="41" viewBox="0 0 55 41" fill="none" xmlns="http://www.w3.org/2000/svg">
									<path d="M19.9114 32.6819C19.3048 36.9459 15.6581 40.2239 11.25 40.2239C6.8419 40.2239 3.19515 36.9459 2.5886 32.6819H0V2.51399C0 1.12556 1.1193 0 2.5 0H37.5C38.8807 0 40 1.12556 40 2.51399V7.54198H47.5L55 17.738V32.6819H49.9115C49.3047 36.9459 45.658 40.2239 41.25 40.2239C36.842 40.2239 33.1953 36.9459 32.5885 32.6819H19.9114ZM35 5.02799H5V25.2669C6.58815 23.6371 8.80165 22.6259 11.25 22.6259C14.7405 22.6259 17.7536 24.6811 19.158 27.6539H33.342C33.7612 26.7665 34.324 25.9605 35 25.2669V5.02799ZM40 20.1119H50V19.3955L44.9793 12.57H40V20.1119ZM41.25 35.1959C42.8828 35.1959 44.2718 34.1466 44.7865 32.6819C44.9248 32.2887 45 31.8656 45 31.4249C45 29.3423 43.321 27.6539 41.25 27.6539C39.179 27.6539 37.5 29.3423 37.5 31.4249C37.5 31.8656 37.5752 32.2887 37.7135 32.6819C38.2282 34.1466 39.6172 35.1959 41.25 35.1959ZM15 31.4249C15 29.3423 13.3211 27.6539 11.25 27.6539C9.17893 27.6539 7.5 29.3423 7.5 31.4249C7.5 31.8656 7.5752 32.2887 7.71338 32.6819C8.22818 34.1466 9.61722 35.1959 11.25 35.1959C12.8828 35.1959 14.2718 34.1466 14.7866 32.6819C14.9248 32.2887 15 31.8656 15 31.4249Z" fill="url(#paint0_linear_373_60)"/>
									<defs>
									<linearGradient id="paint0_linear_373_60" x1="3.65506" y1="3.8475" x2="51.6856" y2="40.0025" gradientUnits="userSpaceOnUse">
						...
						<a class="nav-link" id="nav-three-tab" data-toggle="tab" href="#nav-three" role="tab" aria-controls="nav-three" aria-selected="false">
							<span class="icon">
								<svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
									<path d="M6.01492 31.3075L14.519 22.8035L21.59 29.8745L29.4823 21.9822L25 17.5H37.5V30L33.0178 25.5177L21.59 36.9455L14.519 29.8745L8.33364 36.0597C11.9167 41.4485 18.0436 45 25 45C36.0458 45 45 36.0457 45 25C45 13.9543 36.0458 5.00001 25 5.00001C13.9543 5.00001 5 13.9543 5 25C5 27.204 5.35647 29.3245 6.01492 31.3075ZM2.17 35.203L2.14467 35.1777L2.15435 35.168C0.7697 32.0617 0 28.6207 0 25C0 11.1929 11.1929 0 25 0C38.807 0 50 11.1929 50 25C50 38.8072 38.807 50 25 50C14.8271 50 6.07344 43.924 2.17 35.203Z" fill="url(#paint0_linear_373_62)"/>
									<defs>
									<linearGradient id="paint0_linear_373_62" x1="8.68056" y1="12.5" x2="44.6181" y2="45.3125" gradientUnits="userSpaceOnUse">
									<stop stop-color="#CE9856"/>
