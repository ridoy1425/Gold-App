...
@section('content_title')
    <h4 class="mt-2">Question Edit</h4>
@endsection
...
<div class="row page-content">
    <div class="container">
    <form action="{{ route('question.update',$questionEdit->id) }}" method="post">
        @csrf
        {{-- card-body start --}}
                            ...
                            <div class="mb-1 row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control form-control-sm" id="title"
                                        name="title" value="{{ $questionEdit->title }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="mb-1 row">
                                ...
                                <div class="col-sm-8">
                                    <textarea type="text" class="form-control form-control-sm" id="description"
                                        name="description" value="{{ old('description') }}">{{ $questionEdit->description }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
