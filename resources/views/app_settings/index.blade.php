                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                            <div class="site-input-groups">
                                                ...
                                                <input type="text" name="sub_header" class="box-input"
                                                    value="{{ $settings->sub_header ?? '' }}" required>
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                            <div class="site-input-groups">
                                                ...
                                                <input type="text" name="buying_price" class="box-input"
                                                    value="{{ $settings->buying_price ?? '' }}" required>
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                            <div class="site-input-groups">
                                                ...
                                                <input type="text" name="profit_percentage" class="box-input"
                                                    value="{{ $settings->profit_percentage ?? '' }}" required>
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                            <div class="site-input-groups">
                                                ...
                                                <input type="text" name="return_period" class="box-input"
                                                    value="{{ $settings->return_period ?? '' }}" required>
                                            </div>
                                        </div>
                                        <div class="col-xl-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                            <div class="site-input-groups">
                                                ...
                                                <input type="text" name="bank_name" class="box-input"
                                                    value="{{ $bankInfo->bank_name ?? '' }}" required="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                            <div class="site-input-groups">
                                                ...
                                                <input type="text" name="branch_name" class="box-input"
                                                    value="{{ $bankInfo->branch_name ?? '' }}" required="">
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                            <div class="site-input-groups">
