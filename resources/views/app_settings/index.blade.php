                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                                        <div class="site-input-groups">
                                                            ...
                                                            <input type="text" class="box-input" value="Bangladesh"
                                                                disabled="">
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                                    ...
                                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                                        <div class="site-input-groups">
                                                            <label for="" class="box-input-label">New
                                                                Password:</label>
                                                            <input type="password" name="new_password" class="box-input"
                                                                required="">
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                        ...
                                        <div class="site-card-body table-responsive">
                                            <div class="site-datatable">
                                                <div id="user-profit-dataTable_wrapper"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12 col-md-5">
                                                            <div class="dataTables_info" id="user-profit-dataTable_info"
                                                        ...
                                                        <div class="col-sm-12 col-md-7">
                                                            <div class="dataTables_paginate paging_simple_numbers"
                                                                ...
                                                                <ul class="pagination">
                                                                    ...
                                                                    <li class="paginate_button page-item next disabled"
                                                                        id="user-profit-dataTable_next"><a href="#"
                                                                            aria-controls="user-profit-dataTable"
