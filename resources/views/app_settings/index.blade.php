            ...
            <div class="edit__inner__container app__settings__main">
                <div class="site-tab-bars">
                    <ul class="nav nav-pills" id="pills-tab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <a href="" class="nav-link" id="app-poster-tab" data-bs-toggle="pill"
                                data-bs-target="#app-poster" type="button" role="tab" aria-controls="app-poster"
                                aria-selected="true">
                ...
                <div class="tab-content" id="pills-tabContent">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                            <div class="site-input-groups">
                                                ...
                                                <input type="text" name="phone_number"
                                                    value="{{ $settings->phone_number ?? '' }}" class="box-input"
                                                    required="">
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <!-- app poster -->
                    <div class="tab-pane fade" id="app-poster" role="tabpanel" aria-labelledby="app-poster-tab">
                        <div class="site-card">
                            <div class="site-card-header">
                                <h3 class="title">Add Image</h3>
                            </div>
                            <div class="site-card-body">
                                <form action="{{ url('setting/add-poster') }}" method="post"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-xl-5 col-lg-5 col-md-5 col-sm-5">
                                            <div class="site-input-groups">
                                                <input type="file" name="poster" class="box-input" required="">
                                            </div>
                                        </div>
                                        <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2">
                                            <div class="site-input-groups">
                                                    ...
                                                    <tbody>
                                                        @if ($posters)
                                                            @foreach ($posters as $row)
                                                                <tr>
                                                                    <td>{{ $loop->iteration }}</td>
                                                                    <td> <img height="100px" width="300px"
                                                                            src="{{ asset('storage/' . $row->poster) }}"
                                                                            alt=""></td>
                                                                    <td> <a href="{{ URL('setting/poster-delete', $row->id) }}"
                                                                            onclick="return confirm('Are you sure?')">
                                                                            <img src="{{ asset('ui/admin_assets/dist/img/delete_icon.png') }}"
                                                                                alt="Delete" class="action__icon">
                                                                        </a></td>
